...
<head>
<meta charset="UTF-8">
<title>예약정보 업데이트 프로세스</title>
</head>
<jsp:useBean id="Reservation1" class="DataTier.UpdateReserv"/>
<jsp:useBean id="Reservation2" class="DataTier.Reservation"/>
<body>
<% 
   ...
   Reservation1.update(onum, date, time, seat, head, price, onum1);
   ...
   script.println("alert('예약 수정되었습니다.')");
