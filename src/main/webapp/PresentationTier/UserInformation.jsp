<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="DataTier.OverlapID"%>
<%@ page import="DTO.User"%>
<%@ page import="DataTier.Update"%>
...
<body class="body1">
	<form action="../ApplicationTier/UpdateProcess.jsp" method="post" name="fr"
									...
									<div class="col-12">
										<div style="display: flex">
											<input type="text" class="form-control" id="userBirth"
												name="userBirth" maxlength="10" placeholder="${userBirth}"
												disabled>
										</div>
									</div>
								</div>
									...
									<div class="col-12">
										<div style="display: flex">
											<input type="text" class="form-control" id="userGender"
												name="userGender" maxlength="10" placeholder="${userGender}"
												disabled>
										</div>
									</div>
								</div>
