...
<body class="body1" style="padding-top: 100px;">
	<div class="container">
		<div class="col-lg-12">
			<h1 class="mb-3"
				style="color: white; text-align: center; margin-top: 30px; margin-bottom: 20px;">Reservation</h1>
			<form class="needs-validation" action="../ApplicationTier/ReservationProcess.jsp"
				method="post" name="fr" onsubmit="return valueCheck()">
				<div class="row g-3">
					<div class="col-sm-12">
						<label for="firstName" class="form-label" style="color: white;">성함</label>
						<input type="text" class="form-control" id="name" name="name"
							value="" onkeyup="nameCheck()" required>
					</div>
					<span id="alert_name"></span>
					<div>
					<div class="row">
						<label for="country" class="form-label" style="color: white;">휴대폰
							번호</label>  
							<div class="col">
					...
					<div class="col">					
						 <input type="text"
							class="form-control" id="pnum2" name="pnum2" value=""
							placeholder="중간 3~4자리" onkeyup="pnum2Check()" required>
						<div class="invalid-feedback">휴대폰 가운데자리를 입력하세요.</div>
						<span id="alert_pnum2"></span>
					</div>
					<div class="col">
						<input type="text"
							class="form-control" id="pnum3" name="pnum3" value=""
							placeholder="뒷 4자리" onkeyup="pnum3Check()" required>
						<div class="invalid-feedback">휴대폰 끝자리를 입력하세요.</div>
					...
					<div class="col-md-6">
						<label for="" class="form-label" style="color: white;">예약
							날짜</label> <input type="date" class="form-control" id="today" min="today"
							name="date"></input>
						<script>
							document.getElementById('today').valueAsDate = new Date();
						</script>
						<div class="invalid-feedback">예약 날짜를 선택하세요.</div>
					</div>
					<div class="col-md-6">
						<label for="" class="form-label" style="color: white;">예약
							시간 (오후6시~10시까지 30분 단위로 예약 가능)</label> <input type="time"
							class="form-control" id="now" name="time" min="18:00" max="22:00"
							step="1800"></input>
						<div class="invalid-feedback">방문 시간을 입력하세요.</div>
					</div>
					<div class="col-md-12">
						<label for="" class="form-label" style="color: white;">예약
							인원</label> <input type="text" class="form-control" id="head" name="head"
							value="" placeholder="인원수 (숫자만 입력하세요)" onkeyup="headCheck()"
							required> <span id="alert_head"></span>
					</div>
				</div>
				<br> <br>
				...
				<br>
				<div align=center>
					<button class="w-100 btn btn-success btn-lg" type="submit">예약하기</button>
				</div>
			</form>
		</div>
