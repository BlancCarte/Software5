...
<jsp:useBean id="Reservation1" class="user.Reservation" scope="session" />
<body>
<% 
   ...
   String r = "";
   if(n%3==1 && n%3==2 && n%3==3) r="A";
   if(n%3==4 && n%3==5 && n%3==6) r="B";
   if(n%3==7 && n%3==8 && n%3==9 && n%3==0) r="C";
   if(head1>=1 && head1<=2){
	   seat = "2" + "-" + r;
   }
