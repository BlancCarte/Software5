...
public class DaoTest {
	...
	public void addUserTest() throws Exception{//회원가입 테스트
		User user1 = new User("jhkim", "5877", "김재현", "19990114", "한남", "jhkim@naver.com", "010-6398-0875");
		Signup signup = new Signup();
		Login login = new Login();
		signup.signUp("jhkim", "5877", "김재현", "19990114", "한남", "jhkim@naver.com", "010-6398-0875", "1", "1");
	...
	public void updateUserTest() {
		...
		User user1 = new User("jhkim", "5877", "김재현", "19990114", "한남", "jhkim@naver.com", "010-6398-0875");
		update.update("jhkim", "1111", "김재현", "19990114", "한남", "jhkim@naver.com", "010-6398-0875", "1", "1");
